...
# ended up having to have  more than 4 screen name lists due to internet crashing.
screen_names_list_4_x = ['BarryGardiner', 'KeeleyMP', 'Bambos_MP', 'ApsanaBegumMP', 'antony_hig', 'AnthonyMangnal1', 'ab4scambs', 'AnnelieseDodds', 'annietrev', 'AnneMcLaughlin', 'AnneMarieMorris', 'AnnaMcMorrin', 'AngusMacNeilSNP', 'AJRichardsonMP', 'AngelaRayner', 'angelaeagle', 'hammersmithandy', 'AndyMcDonaldMP', 'MrAndy_Carter', 'Andrew4Pendle', 'AndrewSelous', 'AndrewRosindell', 'ALewerMBE', 'AJonesMP', 'GwynneMP', 'griffitha', 'ABridgen', 'AndrewBowie_MP', 'andrealeadsom', 'andreajenkyns', 'AmyCallaghanSNP', 'ASollowayUK', 'amandamilling', 'AlynSmith', 'AlunCairns', 'AlokSharma_RDG', 'amcarmichaelMP', 'alisonthewliss', 'Alison_McGovern', 'aliciakearns', 'Alex_Stafford', 'alexsobel', 'AlexNorrisNN', 'AlexDaviesJones', 'ACunninghamMP', 'AlexChalkChelt', 'alexburghart', 'AlecShelbrooke', 'AlbertoCostaMP', 'AlanMakMP', 'alancampbellmp', 'AlanBrownSNP', 'Afzal4Gorton', 'AdamAfriyie', 'abenaopp', 'AaronBell4NUL']

# gets IDS - just have to "rehydrate" the ids back into the full screen_name name data
friends1_id = []
source_screen_name = []
...
# if the dataframe is too long can trim down to just those who are followed by at least 5 MPs later
